...
class Config {public function __construct() {
  ...
  $this->products = [
    ...
    16 => ['Уборка после ремонта', 'b2b-rem' 'biz-'],
    17 => ['Уборка после строительства', 'b2b-stroy' 'biz-uborka-posle-stroy'],
    18 => ['Уборка  офисов', 'b2b-office' 'biz-человеко/читаемый/url'],
    19 => ['Уборка производственных помещений', 'b2b-proiz' 'biz-человеко/читаемый/url'],
    20 => ['Уборка торговых центров', 'b2b-tc' 'biz-еловеко/читаемый/url'],
    21 => ['Уборка кафе и ресторанов', 'b2b-cafe' 'biz-человеко/читаемый/url'],
    22 => ['Уборка подъездов', 'b2b-pod' 'biz-человеко/читаемый/url'],
    23 => ['Уборка территорий', 'b2b-ter' 'biz-человеко/читаемый/url'],
    24 => ['Уборка школ', 'b2b-school' 'biz-еловеко/читаемый/url'],
    25 => ['Уборка спортзала и фитнес клуба', 'b2b-sport' 'biz-человеко/читаемый/url'],
    26 => ['Уборка на мероприятии', 'b2b-mer' 'biz-человеко/читаемый/url'],
    27 => ['Уборка медицинских центров', 'b2b-med' 'biz-человеко/читаемый/url'],
    28 => ['Уборка автосервисов', 'b2b-autoser' 'biz-человеко/читаемый/url'],
    29 => ['Уборка парковок и паркингов', 'b2b-parkin' 'biz-человеко/читаемый/url'],
    30 => ['Уборка складов', 'b2b-sclad' 'biz-человеко/читаемый/url'],
    31 => ['Уборка салонов красоты', 'b2b-salon' 'biz-человеко/читаемый/url'],
    //----------------------------------------------------
